...
def address_filter(line, handled_dict):
    ...
    # 23个省
        ...
        handled_dict["山西省"] += 1
            ...
            or "丹东" in line or "辽阳" in line or "锦州" in line or "营口" in line or "抚顺" in line:
        handled_dict["辽宁省"] += 1
        ...
        handled_dict["福建省"] += 1
            ...
            or "吉安" in line or "景德" in line or "九江" in line or "高安" in line:
        handled_dict["江西省"] += 1
        ...
        handled_dict["河南省"] += 1
            ...
            or "十堰" in line or "利川" in line or "石首" in line or "当阳" in line or "松滋" in line:
        handled_dict["湖北省"] += 1
        ...
        handled_dict["湖南省"] += 1
            ...
            or "中山市" in line or "湛江" in line or "江门" in line or "東莞" in line or "Guangdong" in line:
        handled_dict["广东省"] += 1
    ...
    # 5自治区
        ...
        handled_dict["内蒙古自治区"] += 1
            ...
            or "市宁" in line or "青秀" in line or "柳州" in line or "桂林" in line:
    ...
    # 2特别行政区
    elif "香港" in line or "HK" in line or "Hong Kong" in line or "HONGKONG" in line or "hong kong" in line:
    ...
    # 国外
        ...
        handled_dict["美国"] += 1
            ...
            or "japan" in line or "Tokyo" in line:
        handled_dict["日本"] += 1
