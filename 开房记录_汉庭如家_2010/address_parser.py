...
class AddressCounter(object):
    def __init__(self):
        ...
        self.alias_dict = {
            ...
            "天津市": (
                "天津", "东丽", "tianjin", "夭津", "塘沽", "蓟县", "西青", "南开", "TIANJIN", "河东",
            ),
            "上海市": (
            ...
            "河北省": (
                ...
                "涞源", "秦皇岛", "衡水", "邢台", "高碑", "遵化", "邯郸", "邯郸", "承德", "焦作", "保定",
            ),
            "山西省": (
            ...
            "吉林省": (
                "吉林", "长春", "南关", "四平", "通化", "jilin", "延吉", "大安", "珲春", "松原", "白山",
            ),
            "黑龙江省": (
                "黑龙江", "哈尔滨", "南岗", "道里", "鸡西", "大庆", "双鸭山", "道外", "佳木斯", "爱辉", "五常", "伊春",
                "牡丹江", "齐齐哈尔", "鹤岗", "海林", "双城", "daqing", "纳河",
            ),
            "江苏省": (
            ...
            "浙江省": (
                ...
                "东阳", "平湖", "乐清", "浙", "丽水", "义乌", "桐乡", "建德", "Zhejiang", "温岭",
            ),
            "安徽省": (
            ...
            "福建省": (
                ...
                "廈門", "xiamen", "石狮", "福鼎", "南平", "漳州", "福安", "南安", "漳平",
            ),
            "江西省": (
            ...
            "山东省": (
                ...
                "临清", "邹城", "济宁", "锢安", "兖州", "青州", "莱西", "乐陵", "莱芜", "诸城",
            ),
            "河南省": (
                "河南", "郑州", "河市省", "鹤壁", "洛阳", "伊川", "项城", "开封", "商城县", "何南", "偃师", "唐河", "罗山",
                "澶河", "安阳", "三门峡", "平顶山", "登封", "许昌", "周口", "汝州", "林州", "长葛",
            ),
            "湖北省": (
                "湖北", "武汉", "洪山", "夷陵", "西陵", "江岸", "猇亭", "鄂州", "武昌", "青山", "伍家", "江汉", "黄陂",
                "孝南", "郢中", "黄破", "荆门", "宜昌", "十堰", "利川", "石首", "当阳", "松滋", "仙桃", "随州", "黄石",
            ),
            "湖南省": (
                "湖南", "长沙", "湖市省", "湘潭", "怀化", "醴陵", "株洲", "雨花", "天心", "涟源", "益阳", "岳阳",
                "汨罗",
            ),
            "广东省": (
                "广东", "广州", "深圳", "顺德", "万江", "萝岗", "凤岗", "黄浦", "南山", "海珠", "虎门", "韶关", "高埗",
                "厚街", "大朗", "东莞", "沙田", "佛山", "黄埔", "龙岗", "荔湾", "汕头", "广 东", "潮州", "茂名", "廣東",
                "廣州", "guangdong", "惠州", "清远", "中山", "湛江", "江门", "東莞", "Guangdong", "肇庆", "肇庆",
                "恩平", "连州", "增城",
            ),
            "海南省": (
                "海南", "海口", "海市", "五指山", "三亚",
            ...
            "台湾省": (
                ...
                "汐止", "彰化", "板橋", "桃園", "樹林", "屏東", "鳳山", "嘉义"
            ),
            # 5自治区
            "内蒙古自治区": (
                "蒙古", "呼和浩特", "包头", "内蒙", "呼伦贝尔", "满洲里", "鄂尔多斯", "赤峰"
            ),
            "广西壮族自治区": (
            ...
            # 2特别行政区
            "香港特别行政区": (
                "香港", "HK", "Hong Kong", "HONGKONG", "hong kong", "HongKong", "港澳", "港澳台"
            ),
            "澳门特别行政区": (
                "澳门", "澳門",
            ),
            # extra
            "中国其它地区": (
                # "中国", "CHN", "个人", "公司", "城区", "大厦", "中区", "开发区", "市区", "人民路", "高新",
                # "小区", "大道", "村", "县", "路", "市"
            ),
...
def main():
    ...
    with open(input_path, mode='r', encoding='utf8') as f:
        while True:
            ...
            if total_lines_counter % 1000000 == 0:
                print(total_lines_counter, file=sys.stderr)
