...
def address_filter(line, handled_dict):
    ...
    if "北京" in line or "海淀" in line or "朝阳" in line or "东城区" in line or "大兴" in line \
            or "丰台" in line or "通州" in line or "海滨" in line or "石景山" in line:
        handled_dict["北京市"] += 1
    ...
    # 23个省
        ...
        handled_dict["山西省"] += 1
            ...
            or "中山区" in line or "盘锦" in line or "和平区" in line:
        handled_dict["辽宁省"] += 1
        ...
        handled_dict["吉林省"] += 1
            ...
            or "双鸭山" in line or "道外" in line or "佳木斯" in line or "爱辉" in line or "五常" in line:
        handled_dict["黑龙江省"] += 1
        ...
        handled_dict["河南省"] += 1
            ...
            or "黄陂" in line or "孝南" in line or "郢中" in line or "黄破" in line:
        handled_dict["湖北省"] += 1
        ...
        handled_dict["云南省"] += 1
            ...
            or "宝鸡" in line or "金台" in line or "凤翔" in line:
        handled_dict["陕西省"] += 1
    elif "甘肃" in line or "兰州" in line or "玉门" in line:
        handled_dict["甘肃省"] += 1
    elif "青海" in line or "果洛藏族" in line or "西宁" in line:
        handled_dict["青海省"] += 1
    elif "台湾" in line or "台北" in line or "高雄" in line or "台灣" in line or "新北" in line:
        handled_dict["台湾省"] += 1
    # 5自治区
    ...
    # extra
            ...
            or "中区" in line or "开发区" in line or "市区" in line:
